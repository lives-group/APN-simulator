...
\end{itemize}
 ...
 \end{itemize}
  ...
  Considere a expressão regular $(a|b)*a$. Podemos facilmente verificar que as palavras $a$, $ba$ e $baba$ pertencem a liguagem gerada por essa
...
logo a derivada de $(a\;|\;\varepsilon)\,b\,c$ em relação ao símbolo $b$ é a ER $c$.
...
\section{Linguagens Livres de Contexto e Autômatos de Pilha}
