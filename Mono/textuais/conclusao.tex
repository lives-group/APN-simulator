...
=======
Entre as principais contribuições do projeto desenvolvido estão: a criação de APNs; a visualização dos múltiplos caminhos de execução de um APN passo a passo; correção automática de exercícios; tudo em uma plataforma completamente online, sem necessidade de instalação no computador.

>>>>>>> 0c09a2e97ba967b9174e8eb9f969555c283a2f04
