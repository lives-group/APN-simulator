...
A execução será feita com base em mais dois valores mostrados nessa figura, onde está escrito 1000 está definido o número maximo de passos de execução que esse autômato pode executar antes que a sua parada seja forçada, dado que APNs podem entrar em loop infinito. Além disso existe o seletor onde está escrito FS onde é informado o tipo de aceitação do sistema, sendo, FS estado final e pilha vazia, F apenas estado final e S apenas pilha vazia. 
