    ...
    startPopups() {
        ...
        this.nodeP.initial.onclick = () => {
            if (this.cy.getElementById(this.nodeP.index).data("initial")) {
                ...
                this.cy.getElementById(this.nodeP.index).style({ 'background-image': 'url(https://lives-group.github.io/APN-simulator/img/inicial.png)' });
    ...
    import(obj) {
        ...
        for (const node of obj.nodes) {
            ...
            if (this.cy.getElementById(this.counter).data("initial")) {
                ...
                this.cy.getElementById(this.counter).style({ 'background-image': 'url(https://lives-group.github.io/APN-simulator/img/inicial.png)' });
